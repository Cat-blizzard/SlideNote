...
def _build_parser() -> argparse.ArgumentParser:
    ...
    build.add_argument(
        ...
        default="balanced",
        help="Preset for cost/time limits. It fills unset limits but does not enable OCR, vision, or LLM by itself.",
    )
...
def _build(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        progress.start_stage("notes", total=len(deck.pages) if args.use_llm else None, message="Generating notes")
