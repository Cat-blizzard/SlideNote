...
def _study_pack_prompt(
    ...
    return (
        ...
        "5. source_refs 使用简洁页码，如 P1、P3-P5；不要输出内部 element id，除非原文必须调试。\n"
        "6. 如果 requested_outputs.review=false，review 可为 null；如果 requested_outputs.exam=false，exam 可为 null。\n"
        "JSON schema:\n"
        "{\n"
        ...
        '  "exam": {"title": "...", "subtitle": "...", "questions": [{"id": "q1", "type": "choice", "points": 2, "question": "...", "options": ["..."], "answer": 0, "explanation": "...", "pitfall": "...", "source_refs": ["P1"]}]}\n'
        "}\n\n"
...
def _collect_study_items(
    ...
    for page in deck.pages:
        ...
        for image in page.images:
            ...
            if text:
                item = _build_local_report_item(section, _point_from_text(text), text, page.slide_id, role="figure_explanation")
                _add_unique(items, item, seen)
