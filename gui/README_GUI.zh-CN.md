...
- 查看进度、ETA、Doctor 检查、quality / coverage / source map / page explorer / cost report。
- 在结果页基于已有输出目录生成复习包：`review.md`、`exam.md`、`exam.json`、`exam.html` 等。
...
`build` 完成后进入结果页的 **Study pack** 标签，点击 **Generate study pack from this output**。GUI 会对已有输出目录运行：
