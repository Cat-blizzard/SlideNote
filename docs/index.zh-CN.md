...
4. 想调质量和成本，看 [Provider、OCR、Vision、缓存与成本](providers-and-cost.zh-CN.md)。
...
7. 想看后续方向，看 [ROADMAP.zh-CN.md](../ROADMAP.zh-CN.md) 和 [路线图设计笔记](roadmap/extension-notes.zh-CN.md)。
...
| [CONFIG.zh-CN.md](../CONFIG.zh-CN.md) | CLI/config 参数参考。 |
