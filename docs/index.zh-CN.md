...
4. 想快速查命令、preset 和环境变量，看 [CONFIG 配置指南](../CONFIG.zh-CN.md)。
5. 想理解 provider、OCR、Vision 和成本背景，看 [Provider、OCR、Vision、缓存与成本](providers-and-cost.zh-CN.md)。
...
| [Presets](presets.zh-CN.md) | 用户侧 `--preset lecture|local` 的定位。 |
